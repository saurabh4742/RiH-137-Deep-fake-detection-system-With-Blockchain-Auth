...
def chatbot_response(user_input):
    ...
    responses = {
        ...
        "deep fake": "Deep fakes are AI-generated media that can manipulate real video or audio to mislead viewers. I can help you detect them in images or videos.",
        "deepfake": "Deep fakes are AI-generated media that can manipulate real video or audio to mislead viewers. I can help you detect them in images or videos.",
        "ethics": "The ethics of AI involve concerns about privacy, fairness, transparency, and accountability. For example, using deep fake technology to deceive or harm others is unethical and can have serious consequences.",
        "legal": "The legal use of AI is a complex area. It's essential to ensure AI is used in a way that complies with existing laws, such as data protection, intellectual property rights, and avoiding harm to individuals or society.",
        "false information": "Deep fake videos can be used to spread false information, leading to significant harm. It's crucial to develop tools and regulations to combat this misuse of technology.",
        "misinformation": "Deep fake videos can be used to spread false information, leading to significant harm. It's crucial to develop tools and regulations to combat this misuse of technology.",
        "how to upload": "To upload an image or video, simply click on the 'Choose an image...' or 'Choose a video...' button depending on your selection. You can upload images in jpg, jpeg, or png formats, and videos in mp4, avi, or mov formats.",
        "size of video": "The recommended image size is under 10MB, and videos should be under 100MB to ensure smooth processing. Larger files may take longer to process and could result in timeouts.",
        "size of image": "The recommended image size is under 10MB, and videos should be under 100MB to ensure smooth processing. Larger files may take longer to process and could result in timeouts.",
        "how this project works": "This project detects deep fake images and videos using a machine learning model trained on the Xception network. For images, the uploaded image is preprocessed and passed through the model to predict whether it is real or fake. For videos, the video is split into frames, and each frame is analyzed individually. A summary of the results is provided based on the analysis of all frames.",
        "how does this work": "This project detects deep fake images and videos using a machine learning model trained on the Xception network. For images, the uploaded image is preprocessed and passed through the model to predict whether it is real or fake. For videos, the video is split into frames, and each frame is analyzed individually. A summary of the results is provided based on the analysis of all frames.",
